...
airline_dict = {'AirAsia': 0, "Indigo": 1, "GO_FIRST": 2, "SpiceJet": 3, "AirIndia": 4, "Vistara": 5}
...
destination_dict = {'Delhi': 0, "Hyderabad": 1, "Bangalore": 2, "Mumbai": 3, "Kolkata": 4, "Chennai": 5}
...
def predict (): 
    ...
    try:
        ...
        departure_dict = departure_dict[data['departure_time']]
        ...
        features = [airline, source_city, departure_dict, stops, arrival_time, destination_city, travel_class, date_diff]
